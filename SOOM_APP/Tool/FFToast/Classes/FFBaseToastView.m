        ...
        [UIView animateWithDuration:0.5f
             ...
             usingSpringWithDamping:0.7f
              initialSpringVelocity:0.5f
                         ...
                         animations:^{
                             self.frame = self->_toastViewFrame;
                             self.alpha = self->_toastAlpha;
        ...
        @synchronized (toastArray) {
            ...
            if (self.dismissToastAnimated == YES && _toastPosition != FFToastPositionBottom && _toastPosition != FFToastPositionBottomWithFillet)
            {
                ...
                [UIView animateWithDuration:0.2f animations:^{
                                     toast.alpha = 0.f;
                                     self.frame = CGRectMake(self->_toastViewFrame.origin.x,
                                                             -(self->_toastViewFrame.size.height + tempStatusBarHeight),
                                                             self->_toastViewFrame.size.width,
                                                             self->_toastViewFrame.size.height);
                                 } completion:^(BOOL finished) {
